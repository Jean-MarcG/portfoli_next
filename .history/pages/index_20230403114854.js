        ...
        <section>
          ...
          <div className='flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap'>
            <div className='basis-1/3 flex-1'>
              <Image src={web1} alt='' className='rounded-lg object-cover' width={'100%'} height={'100%'} fill />
            </div>
            <div className='basis-1/3 flex-1'>
              <Image src={web2} alt='' className='rounded-lg object-cover' width={'100%'} height={'100%'} fill />
            </div>
            <div className='basis-1/3 flex-1'>
              <Image src={web3} alt='' className='rounded-lg object-cover' width={'100%'} height={'100%'} fill />
            </div>
            <div className='basis-1/3'>
              <Image src={web4} alt='' className='rounded-lg object-cover' width={'100%'} height={'100%'} fill />
            </div>
            <div className='basis-1/3 flex-1'>
              <Image src={web5} alt='' className='rounded-lg object-cover' width={'100%'} height={'100%'} fill />
            </div>
            <div className='basis-1/3 flex-1'>
              <Image src={web6} alt='' className='rounded-lg object-cover' width={'100%'} height={'100%'} fill />
            </div>
          </div>
        </section>
      </main>

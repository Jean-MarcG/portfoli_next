        ...
        <section>
          ...
          <div>
            <div className='text-center shadow-lg p-10 rounded-xl my-10'>
              <Image className='h-auto max-w-full rounded-lg' src={design} alt='image design' width={100} height={100} />
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10'>
              <Image src={code} alt='image code' width={100} height={100} />
              <h3 className='text-lg font-medium pt-8 pb-2'>Beautiful Designs</h3>
              <p>
                Creating elegant designs suited for your needs following core design theory.
              </p>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10'>
              <Image src={consulting} alt='image design' width={100} height={100} />
              <h3 className='text-lg font-medium pt-8 pb-2'>Beautiful Designs</h3>
              <p>
                Creating elegant designs suited for your needs following core design theory.
              </p>
